...
*/
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            //String s = "1";
            String sql = "Select src.train as train_number,src.station as station, src.departure as departure , dst.arrival as reach "+
            ...
            if (!resultSet.next() ) {
                ...
                do {
                    int trainno = resultSet.getInt("train_number");
                    ...
                    writer.print("<td>");
                    writer.print(resultSet.getString("reach"));
                    writer.print("</td>");
            ...
            System.out.println("Getting this means that there might be incomplete data entered into the database          " +e );
            e.printStackTrace();
        }
